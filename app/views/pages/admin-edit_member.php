<div class="container">
 <div class="wrapper pull-left m">
    	...
    	<div class="page-title">
            <a href="<?= SITE ?>/admin/members" class="btn pull-right">Back</a>
        	<h1>Edit Member</h1>
            <p>Perbarui informasi atau data member dengan benar dan jelas</p>
        </div>
    
    	<form action="<?= SITE ?>/admin/edit_member" method="post" enctype="multipart/form-data" class="form">
        	<label class="block">
            	<b>Nama Lengkap</b>
