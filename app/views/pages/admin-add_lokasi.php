...
<div class="wrapper pull-left m">
    	...
    	<div class="page-title">
         <a href="<?= SITE ?>/admin/lokasi" class="btn pull-right">Back</a>
        	<h1>Add Lokasi</h1>
            <p>Masukan nama lokasi</p>
        </div>
    
    	<form action="<?= SITE ?>/admin/add_lokasi" method="post" class="form">
        	<label class="block">
            	<b>Nama Lokasi</b>
                <input type="text" name="lokasi" class="form-control" required="required" style="width:300px;" />
            </label>
